...
pytestmark = pytest.mark.skip("skip all mrun tests for now")

class TestMRun(object):
    """
    This class tests functionality around the mrun tool. It has some
    ...
    def test_test(self):
        """TestMRun setup and teardown test."""
    ...
    def test_argv_run(self):
        """
        mrun: test true command line arguments, instead of passing
        into tool.run().
        """

        # make command line arguments through sys.argv
        sys.argv = ['mrun', 'init', '--single', '--dir', self.base_dir,
    ...
    def test_init_default(self):
        """mrun: test that 'init' command can be omitted, is default. """

        # make command line arguments through sys.argv
        sys.argv = ['mrun', '--single', '--dir', self.base_dir,
                    '--port', str(self.port), '--nojournal']
    ...
    def test_init_default_arguments(self):
        """
        mrun: test that 'init' command is default, even when specifying
        arguments to run().
        """
    ...
    def test_single(self):
        """mrun: start stand-alone server and tear down again."""
    ...
    def test_verbose_sharded(self):
        ...
        assert self.helper_output_has_line_with(['writing .mrun_startup '
                                                 'file'], output)
    ...
    def test_shard_names(self):
        """mrun: test if sharded cluster with explicit shard names works."""
    ...
    def test_startup_file(self):
        """mrun: create .mrun_startup file in data path."""
        ...
        startup_file = os.path.join(self.data_dir, '.mrun_startup')
    ...
    def test_single_mongos_explicit(self):
        """
        mrun: test if single mongos is running on start port and creates
        <datadir>/mongos.log.
        """
    ...
    def test_single_mongos(self):
        """
        mrun: test if multiple mongos use separate log files in 'mongos'
        subdir.
        """
    ...
    def test_filter_valid_arguments(self):
        """Check arguments unknown to mrun against mongos and mongod."""
    ...
    def test_large_replicaset_arbiter(self):
        """mrun: start large replica set of 7 nodes with arbiter."""
    ...
    def test_large_replicaset_noarbiter(self):
        """mrun: start large replica set of 7 nodes without arbiter."""
    ...
    def test_kill_default(self):
        """mrun: test killing all nodes with default signal."""
    ...
    def test_kill_sigterm(self):
        """mrun: test killing all nodes with SIGTERM."""
    ...
    def test_kill_sigkill(self):
        """mrun: test killing all nodes with SIGKILL."""
    ...
    def test_stop_start(self):
        """mrun: test stop and then re-starting nodes."""
    ...
    def test_restart_with_unkown_args(self):
        """mrun: test start command with extra unknown arguments."""
    ...
    def test_init_init_replicaset(self):
        """mrun: test calling init a second time on the replica set."""
    ...
    def test_replicaset_with_name(self):
        """mrun: test calling init on the replica set with given name."""
    ...
    def test_adding_default_user_no_mongos(self):
        """mrun: test that even with --mongos 0 there is a user created."""
    ...
    def test_adding_custom_user(self):
        """mrun: test custom username and password and custom roles."""
    ...
    def test_existing_environment(self):
        """mrun: test warning for overwriting an existing environment."""
    ...
    @unittest.skip('mrun protocol upgrade is not needed at this point')
    def test_upgrade_v1_to_v2(self):
        """mrun: test upgrade from protocol version 1 to 2."""
    ...
    def test_mrun_binary_path_start(self):
    ...
    def test_single_and_arbiter(self):
        """mrun: test --single with --arbiter error."""

        self.run_tool("init --single --arbiter")

    def test_oplogsize_config(self):
        """mrun: test config server never receives --oplogSize parameter."""
