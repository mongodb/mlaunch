...
Before contributing code or documentation to the mongokit project, please
...
mongokit is not overly prescriptive in terms of style: readability and
...
If you implement a new feature anywhere in mongokit, please write a test
function or test class for the feature and document it.

PEP 8
-----

mongokit adheres to most of the standard Python guidelines provided in `PEP 8
...
mongokit documentation is written in `reStructuredText
<http://www.sphinx-doc.org/en/stable/rest.html>`__ and built using `Sphinx
<http://www.sphinx-doc.org/en/stable/index.html>`__.

The mongokit documentation uses only standard RST and Sphinx syntax. As a general
