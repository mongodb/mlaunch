...
mongokit uses the following testing tools:
...
tox is required for testing mongokit and building the documentation:
...
<https://github.com/mongodb/mongokit/blob/develop/tox.ini>`__. It consists of
...
.. code::
   ...
   # C901 skipped: 'MKitTool.init' is too complex
